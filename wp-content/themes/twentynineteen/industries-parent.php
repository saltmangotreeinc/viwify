<?php
/*
Template Name: Industries Parent
*/
?>
<?php get_header(); ?>
...
<!-- WELCOME
    ================================================== -->
<section class="position-relative py-8 py-md-11 mb-12">
    ...
    <div class="row align-items-center">
      <div class="col-12 col-md-6 order-md-2">
        ...
        <div class="img-skewed img-skewed-left mb-8 mb-md-0">
          <img src="<?php bloginfo('template_directory');?>/assets/img/screenshots/desktop/dashkit.jpg" alt="..."
            class="screenshot img-fluid mw-md-130" data-aos="img-skewed-item-left" data-aos-delay="100">
        </div>
      ...
      <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
        ...
        <p class="lead text-muted mb-6 mb-md-8">
          Intelligent developers use our Dashkit theme to build their internal tools and client admin applications. Save
          yourself time and money.
        </p>

        <!-- Buttons -->
        <a href="desktop-app.html#!" class="btn btn-primary mr-1 lift">
          Start for free <i class="fe fe-arrow-right ml-3"></i>
        </a>
        <a href="desktop-app.html#!" class="btn btn-primary-soft lift">
          Learn more
        </a>
...
<section class="pt-10 pt-md-10 pb-12 pb-md-12 bg-gray-200">
  <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-md-6 d-flex">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <!-- Image -->
              <a class="card-img-top" href="blog.html#!">

                <!-- Image -->
                <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-28.jpg" alt="..."
                  class="card-img-top">
              ...
              <!-- Body -->
              <a class="card-body" href="blog.html#!">
                ...
                <p class="mb-0 text-muted">
                  ...
                  faucibus lorem at viverra. Integer at feugiat odio. In placerat euismod risus proin erat purus.
                </p>

              </a>

              <!-- Meta -->
              <a class="card-meta mt-auto" href="blog.html#!">
                ...
                <div class="avatar avatar-sm mr-2">
                  <img src="<?php bloginfo('template_directory');?>/assets/img/avatars/avatar-1.jpg" alt="..."
          ...
          <div class="col-12 col-md-6 d-flex">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="blog.html#!">
                ...
                <!-- Image -->
                <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-29.jpg" alt="..."
                  class="card-img-top">
              ...
              <a class="card-meta mt-auto" href="blog.html#!">
                ...
                <!-- Avatar -->
                <div class="avatar avatar-sm mr-2">
                  <img src="<?php bloginfo('template_directory');?>/assets/img/avatars/avatar-2.jpg" alt="..."
                    class="avatar-img rounded-circle">
                </div>
