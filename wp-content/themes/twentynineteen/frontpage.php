        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="text-center">
              <img src="<?php bloginfo('template_directory');?>/assets/img/illustrations/illustration-1.png" alt="..." class="img-fluid mb-3" style="width: 200px;">
            </div>
        ...
        <div class="modal-content">
          <div class="card card-row">
            <div class="row no-gutters">
              <div class="col-12 col-md-6 bg-cover card-img-left" style="background-image: url('<?php bloginfo('template_directory');?>/assets/img/photos/photo-8.jpg');">

                <!-- Image (placeholder) -->
                <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-8.jpg" alt="..." class="img-fluid d-md-none invisible">
    ...
    <div class="modal fade" id="modalSigninHorizontal" tabindex="-1" role="dialog" aria-labelledby="modalSigninHorizontalTitle" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="card card-row">
            <div class="row no-gutters">
              <div class="col-12 col-md-6 bg-cover card-img-left" style="background-image: url('<?php bloginfo('template_directory');?>/assets/img/photos/photo-1.jpg');">

                <!-- Image (placeholder) -->
                <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-1.jpg" alt="..." class="img-fluid d-md-none invisible">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="card">
            ...
            <!-- Image -->
            <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-21.jpg" alt="..." class="card-img-top">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="navbarLandings" data-toggle="dropdown" href="index.html#" aria-haspopup="true" aria-expanded="false">
                Landings
              </a>
              <div class="dropdown-menu dropdown-menu-xl p-0" aria-labelledby="navbarLandings">
                <div class="row no-gutters">
                  <div class="col-12 col-lg-6">
                    <div class="dropdown-img-left" style="background-image: url('<?php bloginfo('template_directory');?>/assets/img/photos/photo-3.jpg');">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="navbarPages" data-toggle="dropdown" href="index.html#" aria-haspopup="true" aria-expanded="false">
                Pages
              </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="navbarAccount" data-toggle="dropdown" href="index.html#" aria-haspopup="true" aria-expanded="false">
                Account
              </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="navbarDocumentation" data-toggle="dropdown" href="index.html#" aria-haspopup="true" aria-expanded="false">
                Documentation
              </a>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="<?php bloginfo('template_directory');?>/assets/img/illustrations/illustration-2.png" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center justify-content-between mb-8 mb-md-11">
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1" data-aos="fade-right">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <!-- Image -->
              <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-2.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-5 col-lg-6">
            ...
            <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
              ...
              <div class="img-skewed img-skewed-left">
                ...
                <!-- Image -->
                <img src="<?php bloginfo('template_directory');?>/assets/img/screenshots/desktop/dashkit.jpg" class="screenshot img-fluid img-skewed-item" alt="...">
              ...
              <div class="row no-gutters">
                <div class="col-12 col-md-6">
                  ...
                  <div class="card-img-slider" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#blogSlider", "draggable": false}'>
                    <a class="card-img-left bg-cover" style="background-image: url('<?php bloginfo('template_directory');?>/assets/img/photos/photo-1.jpg');" href="index.html#!">

                      <!-- Image (placeholder) -->
                      <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-1.jpg" alt="..." class="img-fluid d-md-none invisible">

                    </a>
                    <a class="card-img-left bg-cover" style="background-image: url('<?php bloginfo('template_directory');?>/assets/img/photos/photo-26.jpg');" href="index.html#!">

                      <!-- Image (placeholder) -->
                      <img src="<?php bloginfo('template_directory');?>/assets/img/photos/photo-26.jpg" alt="..." class="img-fluid d-md-none invisible">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="<?php bloginfo('template_directory');?>/assets/img/illustrations/illustration-8.png" alt="..." class="img-fluid mb-6 mb-md-0">
        ...
        <div class="row align-items-center no-gutters">
          <div class="col-12 col-md-6">
            ...
            <div class="card rounded-lg shadow-lg mb-6 mb-md-0" style="z-index: 1;" data-aos="fade-up">
              ...
              <!-- Button -->
              <a href="index.html#!" class="card-btn btn btn-block btn-lg btn-primary rounded-bottom">
                Get it now
              </a>
          ...
          <div class="col-12 col-md-6 ml-md-n3">
            ...
            <div class="card rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
              ...
              <!-- Button -->
              <a href="index.html#!" class="card-btn btn btn-block btn-lg btn-light bg-gray-300 text-gray-700 rounded-bottom">
                Contact us
              </a>
